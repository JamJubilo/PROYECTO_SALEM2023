...
class Estudiantes(models.Model):
    ...
    num_telefono = models.IntegerField(verbose_name="Numero de telfono del estudiante")
    nom_acudiente = models.CharField(max_length=50,verbose_name="nombre acudiente de estudiante")
    telefono_acudiente = models.IntegerField(verbose_name="Numero de telefono del acudiente")
